...
class Database {
    ...
    public function __construct()
    {
        try
        {
            $this->pdo = new PDO(Config::get('database/dsn'), Config::get('database/username'), Config::get('database/password'), array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES '" . Config::get('database/charset') . "';"));
